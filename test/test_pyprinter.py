...
def eval_code(sceneobj):
  ...
  assert type(dic[sceneobj.name]) == type(sceneobj) and dic[sceneobj.name].name == sceneobj.name
...
def test_bezierpatch():
  bp = BezierPatch([[(0,0,0),(.5,1,0),(1.,1,0),(1.5,0,0)],[(0,0,1),(.5,1,1),(1.,1,1),(1.5,0,1)],[(0,0,3),(.5,1,3),(1.,1,3),(1.5,0,3)]])
  bp.apply(printer)
  eval_code(bp)
