...
function(pglwrapper_install libwrapname repository)
    ...
    message("Installing ${libwrapname} in ${PROJECT_SOURCE_DIR}/src/openalea/plantgl/${repository}")
    install(TARGETS ${libwrapname} DESTINATION "${PROJECT_SOURCE_DIR}/src/openalea/plantgl/${repository}")
endfunction()
