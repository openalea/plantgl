...
void export_Turtle()
{
  ...
  class_< Turtle >("Turtle", init< optional<TurtleParam * > >("Turtle([TurtleParam]) -> Create Turtle"))
    ...
    .def("nF", (void (Turtle::*) (real_t,real_t))&Turtle::nF, (bp::arg("length"),bp::arg("dlength")))
    ...
    .def("lineTo",(void (Turtle::*) (const Vector3&,real_t))&Turtle::lineTo, (bp::arg("position")=Vector3(0,0,0),bp::arg("topradius")=-1.) )
    .def("lineTo",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::lineTo, (bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topradius")=-1.) )
    .def("lineRel",(void (Turtle::*) (const Vector3&,real_t))&Turtle::lineRel, (bp::arg("position")=Vector3(0,0,0),bp::arg("topradius")=-1.) )
    .def("lineRel",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::lineRel, (bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topradius")=-1.)  )
    .def("oLineTo",(void (Turtle::*) (const Vector3&,real_t))&Turtle::oLineTo, (bp::arg("position")=Vector3(0,0,0),bp::arg("topradius")=-1.) )
    .def("oLineTo",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::oLineTo,(bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topradius")=-1.)  )
    .def("oLineRel",(void (Turtle::*) (const Vector3&,real_t))&Turtle::oLineRel, (bp::arg("position")=Vector3(0,0,0),bp::arg("topradius")=-1.) )
    .def("oLineRel",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::oLineRel, (bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topradius")=-1.)  )
    ...
    .def("sweep", (void (Turtle::*) (const Curve2DPtr&,const Curve2DPtr&,real_t,real_t,real_t,const QuantisedFunctionPtr))&Turtle::sweep, (bp::arg("path"),bp::arg("section"),bp::arg("length"),bp::arg("dlength"),bp::arg("radiusmagnitude")=1.0,bp::arg("radiusvariation")=QuantisedFunctionPtr()))
    .def("sweep", (void (Turtle::*) (const LineicModelPtr&,const Curve2DPtr&,real_t,real_t,real_t,const QuantisedFunctionPtr))&Turtle::sweep, (bp::arg("path"),bp::arg("section"),bp::arg("length"),bp::arg("dlength"),bp::arg("radiusmagnitude")=1.0,bp::arg("radiusvariation")=QuantisedFunctionPtr()))
