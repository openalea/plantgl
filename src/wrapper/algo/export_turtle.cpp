...
void export_Turtle()
{
  ...
  class_< Turtle >("Turtle", init< optional<TurtleParam * > >("Turtle([TurtleParam]) -> Create Turtle"))
    ...
    .def("lineTo",(void (Turtle::*) (const Vector3&,real_t))&Turtle::lineTo, (bp::arg("position")=Vector3(0,0,0),bp::arg("topdiameter")=-1.) )
    .def("lineTo",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::lineTo, (bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topdiameter")=-1.) )
    .def("lineRel",(void (Turtle::*) (const Vector3&,real_t))&Turtle::lineRel, (bp::arg("position")=Vector3(0,0,0),bp::arg("topdiameter")=-1.) )
    .def("lineRel",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::lineRel, (bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topdiameter")=-1.)  )
    .def("oLineTo",(void (Turtle::*) (const Vector3&,real_t))&Turtle::oLineTo, (bp::arg("position")=Vector3(0,0,0),bp::arg("topdiameter")=-1.) )
    .def("oLineTo",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::oLineTo,(bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topdiameter")=-1.)  )
    .def("oLineRel",(void (Turtle::*) (const Vector3&,real_t))&Turtle::oLineRel, (bp::arg("position")=Vector3(0,0,0),bp::arg("topdiameter")=-1.) )
    .def("oLineRel",(void (Turtle::*) (real_t,real_t,real_t,real_t))&Turtle::oLineRel, (bp::arg("x")=0.0,bp::arg("y")=0.0,bp::arg("z")=0.0,bp::arg("topdiameter")=-1.)  )
