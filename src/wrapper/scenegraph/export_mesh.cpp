...
void export_Mesh()
{
  class_<Mesh, MeshPtr, bases<ExplicitModel>, boost::noncopyable>( "Mesh", no_init )
	  ...
	  .DEC_BT_NR_PROPERTY_WD(solid,            Mesh, Solid,           bool)
	  .DEC_BT_NR_PROPERTY_WD(ccw,              Mesh, CCW,             bool)
	  .DEC_BT_NR_PROPERTY_WD(normalPerVertex,  Mesh, NormalPerVertex, bool)
	  .DEC_BT_NR_PROPERTY_WD(colorPerVertex,   Mesh, ColorPerVertex,  bool)
