...
void export_Font()
{
  class_< Font, FontPtr, bases< SceneObject >,boost::noncopyable >
	...
	.DEC_BT_PROPERTY_WD(size,Font,Size,uint32_t)
	.DEC_BT_PROPERTY_WD(bold,Font,Bold,bool)
	.DEC_BT_PROPERTY_WD(italic,Font,Italic,bool)
...
void export_Text()
{
  class_< Text, TextPtr, bases< Geometry >,boost::noncopyable >
	...
	.DEC_BT_PROPERTY_WD(screencoordinates,Text,ScreenCoordinates,bool)
