  ...
  class_< AsymmetricHull, AsymmetricHullPtr, bases< Hull >,boost::noncopyable >
    ("AsymmetricHull", init< optional < const real_t&, const real_t&, const real_t&,
     ...
     ( args("negXRadius","posXRadius","negYRadius","posYRadius",
	    ...
	    "negXHeight,posXHeight,negYHeight,posYHeight,"
            "bottom, top, bottomShape, topShape, slices, stacks])") )
		.DEC_BT_PROPERTY_WDV(negXRadius,AsymmetricHull,NegXRadius,float,DEFAULT_NEG_X_RADIUS)
		.DEC_BT_PROPERTY_WDV(posXRadius,AsymmetricHull,PosXRadius,float,DEFAULT_POS_X_RADIUS)
		.DEC_BT_PROPERTY_WDV(negYRadius,AsymmetricHull,NegYRadius,float,DEFAULT_NEG_Y_RADIUS)
		.DEC_BT_PROPERTY_WDV(posYRadius,AsymmetricHull,PosYRadius,float,DEFAULT_POS_Y_RADIUS)
		.DEC_BT_PROPERTY_WDV(negXHeight,AsymmetricHull,NegXHeight,float,DEFAULT_NEG_X_HEIGHT)
		.DEC_BT_PROPERTY_WDV(posXHeight,AsymmetricHull,PosXHeight,float,DEFAULT_POS_X_HEIGHT)
		.DEC_BT_PROPERTY_WDV(negYHeight,AsymmetricHull,NegYHeight,float,DEFAULT_NEG_Y_HEIGHT)
		.DEC_BT_PROPERTY_WDV(posYHeight,AsymmetricHull,PosYHeight,float,DEFAULT_POS_Y_HEIGHT)
		...
		.DEC_BT_PROPERTY_WDV(bottomShape,AsymmetricHull,BottomShape,float,DEFAULT_BOTTOM_SHAPE)
		.DEC_BT_PROPERTY_WDV(topShape,AsymmetricHull,TopShape,float,DEFAULT_TOP_SHAPE)
