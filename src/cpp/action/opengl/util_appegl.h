...
/*! \fn void glGeomLightMaterial(GLenum light, GLenum pname, const GEOM(Color3)& v, const real_t& alpha = 1.0 )
...
*/
inline void glGeomLightMaterial(GLenum light, GLenum pname, const GEOM(Color3)& v, const real_t& alpha = 1.0 )
...
/*! \fn void glGeomLightMaterial(GLenum light, GLenum pname, const GEOM(Color4)& v  )
    \brief  glLight for GEOM
    \param light must be GL_LIGHT0, ... , GL_LIGHT7.
    \param pname must be GL_AMBIENT, GL_DIFFUSE, GL_SPECULAR.
    \param v must be a valid color.
*/
inline void glGeomLightMaterial(GLenum light, GLenum pname, const GEOM(Color4)& v )
{ GEOM_ASSERT(pname == GL_AMBIENT || pname == GL_DIFFUSE || pname == GL_SPECULAR );
...
/*! \fn void glGeomGetLightMaterial(GLenum light, GLenum pname,GEOM(Color4)& v )
    \brief  glLight for GEOM
    \param light must be GL_LIGHT0, ... , GL_LIGHT7.
    \param pname must be GL_AMBIENT, GL_DIFFUSE, GL_SPECULAR.
...
*/
inline void glGeomGetLightMaterial(GLenum light, GLenum pname,GEOM(Color4)& v )
{ GEOM_ASSERT(pname == GL_AMBIENT || pname == GL_DIFFUSE || pname == GL_SPECULAR );
...
inline void glGeomFogColor(const GEOM(Color4)& v)
{ GLfloat val[] = { v.getRedClamped(), v.getGreenClamped(), v.getBlueClamped(), v.getAlphaClamped() };
  glFogfv ( GL_FOG_COLOR, val); }

/// glFog( GL_FOG_COLOR ) for GEOM
inline void glGeomFogColor(const GEOM(Color3)& v, const real_t& alpha = 1.0)
{ GLfloat val[] = { v.getRedClamped(), v.getGreenClamped(), v.getBlueClamped(), alpha };
  glFogfv ( GL_FOG_COLOR, val); }
...
/// glColor for GEOM
inline void glGeomColor(const GEOM(Color3)& v){
  glColor3ubv(v.getBegin());
}

/// glColor for GEOM
inline void glGeomColor(const GEOM(Color3)& v,const uchar_t& alpha){
  glColor4ub(v.getRed(),v.getGreen(),v.getBlue(),alpha);
}

/// glColor for GEOM
inline void glGeomColor(const GEOM(Color4)& v){
...
/// glMaterial for GEOM
inline void glGeomMaterial(GLenum face, GLenum pname, const GEOM(Color4)& v)
{ GLfloat val[] = { v.getRedClamped(), v.getGreenClamped(), v.getBlueClamped(), v.getAlphaClamped() };
  glMaterialfv (face, pname, val);}

/// glMaterial for GEOM
inline void glGeomMaterial(GLenum face, GLenum pname, const GEOM(Color3)& v, const real_t& alpha = 1.0)
{ GLfloat val[] = { v.getRedClamped(), v.getGreenClamped(), v.getBlueClamped(), alpha };
  glMaterialfv (face, pname, val);}
