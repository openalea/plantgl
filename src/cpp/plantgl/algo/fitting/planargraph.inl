...
#define assertion(a,b) assert(a && b)
...
{
    Primitive* primitive = new Primitive(PT_ISOLATED_VERTEX);
    ...
    std::set<VertexPtr>& heap, std::vector<Primitive*>& primitives)
{
    ...
    else
    {
        ...
        Primitive* primitive = new Primitive(PT_FILAMENT);
    ...
    std::set<VertexPtr>& heap, std::vector<Primitive*>& primitives)
{
    ...
    else if (VCurr == V0)
    {
        ...
        Primitive* primitive = new Primitive(PT_MINIMAL_CYCLE);
