...
/**
   \class GLSkelRenderer
   \brief An action which displays skeletons of shapes.
*/
...
protected:
  ...
  /** A SkelComputer used to compute the skeltons of the objects to be
      displayed. */
  SkelComputer& __skelComputer;
